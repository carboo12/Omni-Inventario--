...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-card/95 text-card-foreground shadow-sm shadow-slate-200/60 transition-shadow hover:shadow-md dark:border-border/50 dark:shadow-none",
      className
    )}
    {...props}
  />
